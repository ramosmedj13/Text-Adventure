...
public class Player {
    ...
    /**
     * Sets added item to key.
     * @param item added key.
     */
    ...
    /**
     * Grabs item from backpack that is "key".
     * @return the key.
     */
    public Backpack getKey() {
        return (Backpack) backpack.getItem("key");
    }

    /**
     *  Sets added item to shovel.
     * @param item added shovel.
     */
    ...
    /**
     * Grabs item from backpack that is "shovel".
     * @return the shovel.
     */
    public Backpack getShovel() {
        return (Backpack) backpack.getItem("shovel");
    }
