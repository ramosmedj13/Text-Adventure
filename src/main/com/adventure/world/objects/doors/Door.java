...
public class Door implements Tangible {
    ...
    /**
     * Default constructor.
     * Sets isOpen value to false.
     * Sets level of door to 1.
     */
    public Door() {
        isOpen = false;
        level = 1;
    ...
    /**
     * Customs constructor that takes in values for each parameter.
     * @param isOpen True or false if door is open.
     * @param level Sets the level door.
     */
