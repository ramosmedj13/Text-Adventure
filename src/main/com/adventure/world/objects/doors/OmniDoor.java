...
public class OmniDoor implements Tangible {
    ...
    public void unlock(OmniKey key) {
        // Check pins through a for-each loop
        // if all pins correct, update isOpen to true and print out message, "The door is unlocked"
        // Else pin is not correct, randomizePins and end method.
        boolean[] keyPins = key.getPins();
